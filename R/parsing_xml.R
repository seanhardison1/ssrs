...
g1 <- xmlParse(file = here::here("data/modis_rrs_645_2000_2010.kml"))
g2 <- xmlParse(file = here::here("data/modis_rrs_645_2010_2020.kml"))
...
for (j in c(1,2)){
  ...
  for (i in 1:length(xml_data$Document)){
    ...
    assign("modis_reflec", rbind(modis_reflec, img_df))
  }
}


save(modis_reflec, file = here::here("data/modis_reflectance_ts.rdata"))
